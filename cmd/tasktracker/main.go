...
import (
	...
	core_config "github.com/Rics69/task-tracker/internal/core/config"
	...
	_ "github.com/Rics69/task-tracker/docs"
)

// @title Golang TaskTracker API
// @version 1.0
// @description TaskTracker App REST-API schema
// @host 127.0.0.1:5050
// @BasePath /api/v1
func main() {
